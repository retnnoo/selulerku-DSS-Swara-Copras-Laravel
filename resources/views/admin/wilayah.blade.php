    ...
    <div class="flex-1 min-w-0 lg:ml-64">
      ...
      <main class="max-w-[1200px] mx-auto px-4 lg:px-8 py-6 space-y-6">
        ...
        <p class="text-slate-500 mb-10">
          Berikut adalah daftar wilayah atau lokasi yang menjadi cakupan sistem. Setiap wilayah berfungsi sebagai acuan dalam proses pengambilan keputusan 
          terkait alternatif yang dinilai, berdasarkan kriteria seperti kecepatan sinyal, cakupan jaringan, kualitas layanan operator, serta faktor pendukung lainnya.
        </p>
