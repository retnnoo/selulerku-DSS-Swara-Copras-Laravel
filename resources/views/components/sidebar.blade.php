<!-- Sidebar -->
    <aside id="sidebar" 
      ...
      <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
        ...
        <a class="block px-3 py-2 rounded-lg hover:bg-blue-100 font-bold hover:text-blue-800 {{ Request::is('dashboard-admin/pembobotan') ? 'bg-blue-100 text-blue-800' : '' }}" href="{{ route('pembobotan') }}">Pembobotan Kriteria</a>
        <a class="block px-3 py-2 rounded-lg hover:bg-blue-100 font-bold hover:text-blue-800 {{ Request::is('dashboard-admin/rangking-copras') ? 'bg-blue-100 text-blue-800' : '' }}" href="{{ route('copras') }}">Perangkingan Alternatif</a>
